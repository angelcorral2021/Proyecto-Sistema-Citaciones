...
// add content
$pdf->renderTitle('Sistema Citacion de Apoderados');
$pdf->renderSubTitle('FECHA: '.date("d/m/y").'    HORA : '.date("H:i:s"). '   (Hora y fecha generadas al momento de generar el documento)');
$pdf->renderText('Su fecha y hora de citacion esta indicada en la columna Fecha_citacion');
...
$sql = "SELECT * FROM `citacion` WHERE FECHA_Citacion BETWEEN '$_SESSION[fecha1]' AND '$_SESSION[fecha2]'";
